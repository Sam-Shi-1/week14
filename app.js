...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 为箭头按钮添加鼠标事件
    document.querySelector('.banner-prev').addEventListener('mouseenter', stopAutoSlide);
    document.querySelector('.banner-next').addEventListener('mouseenter', stopAutoSlide);
    document.querySelector('.banner-prev').addEventListener('mouseleave', startAutoSlide);
    document.querySelector('.banner-next').addEventListener('mouseleave', startAutoSlide);
});